...
plotter.plot(pareto_front, objectives=[1, 2, 5], xyz_labels="default", c="r", marker="o")
plotter.plot(pareto_front, objectives=[1, 2, 5], xyz_labels="default", c="green", marker="^")
